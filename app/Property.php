...
class Property extends Model implements HasMedia
{
    ...
    public function getDateOfPreviewAttribute($value)
    {
        return $value ? Carbon::parse($value)->format(config('panel.date_format')) : null;
    }

    public function setDateOfPreviewAttribute($value)
    {
        $this->attributes['date_of_preview'] = $value ? Carbon::createFromFormat(config('panel.date_format'), $value)->format('Y-m-d') : null;
    }
