...
<div class="card">
    <div class="card-header">
        <h2>{{ trans('global.create') }} {{ trans('cruds.reportAccident.title_singular') }}</h2>
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.report-accidents.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('car_number') ? 'is-invalid' : '' }}" type="text" name="car_number" id="car_number" value="{{ old('car_number', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('issuer') ? 'is-invalid' : '' }}" type="text" name="issuer" id="issuer" value="{{ old('issuer', '') }}" required>
