...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.update", [$user->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="university">{{ trans('cruds.user.fields.university') }}</label>
                <input class="form-control {{ $errors->has('university') ? 'is-invalid' : '' }}" type="text" name="university" id="university" value="{{ old('university', $user->university) }}" required>
